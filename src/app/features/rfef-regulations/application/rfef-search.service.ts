...
const SYNONYMS: Readonly<Record<string, readonly string[]>> = {
  ...
  pista: ['terreno de juego', 'superficie de juego'],
  cancha: ['terreno de juego', 'superficie de juego'],
  corner: ['saque de esquina'],
  'fuera de banda': ['saque de banda'],
  'uno menos': ['inferioridad numerica', 'dos minutos', 'jugador expulsado'],
  'un jugador menos': ['inferioridad numerica', 'dos minutos', 'jugador expulsado'],
